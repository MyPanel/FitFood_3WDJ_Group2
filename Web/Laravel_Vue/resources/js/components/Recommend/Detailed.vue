            ...
            <v-flex justify-center>
                ...
                <v-layout class="d-flex flex-wrap" style="margin-top: 20px;" justify-center>
                    <v-flex justify-center>
                        ...
                        <div xs12 sm12 md6 justify-center>
                            <div justify-center>
                                <h1 class="text font-weight-bold" style=" margin-top:60px; margin-bottom : 50px; text-align:center; font-family : 'MapoPeacefull';">メニュー</h1>
                                <div style="margin-left:auto; margin:0px auto; text-align:center;">
                                    <v-list style="max-height: 500px" class="overflow-y-auto">
                                        <v-list v-for="(menus,key) in menu" v-bind:key="key">
                                            <h2><strong class="warning--text" style="margin-right:50px; text-align:center; font-family : 'MapoPeacefull';">{{menus.food_name}} : </strong>{{menus.food_price}} 円<br>
                                            </h2>
                ...
                <div justify-center>
                    ...
                    <v-flex class="text-md-center" xs12 sm12 md12 justify-center>
                        <h1 class="font-weight-bold" style="margin-top:30px; text-align:center; font-family : 'MapoPeacefull';">店の位置</h1>
