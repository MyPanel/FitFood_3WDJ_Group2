              ...
              <List>
                <ListItem >
                  ...
                  <TouchableOpacity>
                    ...
                    >週刊レポート</Text>
                    <Icon name="ios-arrow-dropright" style={{ color: '#ff9f0d', fontSize: 20, paddingTop: 9 }} onPress={() => {
