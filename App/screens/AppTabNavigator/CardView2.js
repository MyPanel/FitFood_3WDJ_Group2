...
export default class CardView2 extends React.Component {
  ...
  onButtonPress = (data) => {
    ...
    if (this.state.buttonColor == '#ff9f0d') {
      ...
      this.setState({ buttonColor: '#ff9f0d' }) // red
    }
  }
        ...
        <View style={{ flexDirection: 'row' }}>
          <View style={{ marginLeft: 10, marginTop: 10 }}>
            ...
            <View style={{ marginTop: 5 }}>
              <Text style={{ fontSize: 11, fontWeight: "bold" }}>{data[2]}</Text>
            </View>
          </View>
          <View style={{ marginLeft: 10, marginTop: 10 }}>
            <TouchableOpacity
            ...
            <View style={{ marginTop: 5 }}>
              <Text style={{ fontSize: 11, fontWeight: "bold" }}>{data[5]}</Text>
            </View>
          </View>
          <View style={{ marginLeft: 10, marginTop: 10 }}>
            <TouchableOpacity
            ...
            <View style={{ marginTop: 5 }}>
              <Text style={{ fontSize: 11, fontWeight: "bold" }}>{data[8]}</Text>
            </View>
          </View>
        </View>
        <View style={{ flexDirection: 'row' }}>
          <Icon
            ...
            size={13}
            containerStyle={{ paddingLeft: 290 }}
          />
        </View>
        {/* 레시피 다이얼로그 */}
